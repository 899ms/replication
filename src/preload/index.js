...
contextBridge.exposeInMainWorld("replication", {
  ...
  getVideoInterface: () => ipcRenderer.invoke("replication:video-interface"),
  saveVideoInterface: (input) => ipcRenderer.invoke("replication:save-video-interface", input),
  testVideoInterface: () => ipcRenderer.invoke("replication:test-video-interface"),
